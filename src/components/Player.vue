...
export default {
  ...
  methods: {
    ...
    onMouseUp(transPos) {
      ...
      console.log(this.drawnDots);
      for (let dot of this.drawnDots) {
    ...
    scheduleSong(jempSong) {
      ...
      for (let jempTone of jempTones) {
        ...
        Tone.Transport.schedule(() => {
          ...
          jemp.isActive = true;
          this.drawnDots.push(jemp);
          //play sound
          this.sampler.triggerAttack(jempTone.tone); //TODO time info wird nicht in das array drawnDots mitgespeichert!!!
        }, jempTone.time);
      }
    },
